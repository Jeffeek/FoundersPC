...
namespace FoundersPC.Web.Services.Web_Services.Identity.Admin_services.Users
{
    public class UsersInformationService : IUsersInformationService
    {
        ...
        public async Task<UserEntityReadDto> GetUserByIdAsync(int id, string adminToken)
        {
            ...
            var request = await client.GetFromJsonAsync<UserEntityReadDto>(IdentityServerRoutes.BuildRouteById($"{IdentityServerRoutes.Users.UsersEndpoint}/{IdentityServerRoutes.Users.Get.ById}", id));
        ...
        public async Task<UserEntityReadDto> GetUserByEmailAsync(string email, string adminToken)
        {
            ...
            var request = await client.GetFromJsonAsync<UserEntityReadDto>(IdentityServerRoutes.BuildRouteByEmail($"{IdentityServerRoutes.Users.UsersEndpoint}/{IdentityServerRoutes.Users.Get.ByEmail}", email));
        ...
        public async Task<IEnumerable<UserEntityReadDto>> GetAllUsersAsync(string adminToken)
        {
            ...
            var request = await client.GetFromJsonAsync<IEnumerable<UserEntityReadDto>>(IdentityServerRoutes.Users.UsersEndpoint);
                                                                                            ...
                                                                                            string adminToken)
        {
            ...
            var result =
                await client
                    .GetFromJsonAsync<PaginationResponse<UserEntityReadDto>>($"{IdentityServerRoutes.Users.UsersEndpoint}{ApplicationRestAddons.BuildPageQuery(pageNumber, pageSize)}");

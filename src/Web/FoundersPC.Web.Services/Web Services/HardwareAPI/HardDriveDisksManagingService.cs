...
{
    public class HardDriveDisksManagingService : BoilerplaitManagingService<HardDriveDiskInsertDto, HardDriveDiskReadDto, HardDriveDiskUpdateDto>, IHardDriveDisksManagingService
    {

...
{
    public class SolidStateDrivesManagingService : BoilerplaitManagingService<SolidStateDriveInsertDto, SolidStateDriveReadDto, SolidStateDriveUpdateDto>,
                                                   ISolidStateDrivesManagingService
    {

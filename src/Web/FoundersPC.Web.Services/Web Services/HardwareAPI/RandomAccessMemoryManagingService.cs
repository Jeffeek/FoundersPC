...
{
    public class RandomAccessMemoryManagingService :
        BoilerplaitManagingService<RandomAccessMemoryInsertDto, RandomAccessMemoryReadDto, RandomAccessMemoryUpdateDto>,
        IRandomAccessMemoryManagingService
    {

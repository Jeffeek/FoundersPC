...
{
	public class VideoCardCoresManagingService : BoilerplaitManagingService<VideoCardCoreInsertDto, VideoCardCoreReadDto, VideoCardCoreUpdateDto>, IVideoCardCoresManagingService
	{

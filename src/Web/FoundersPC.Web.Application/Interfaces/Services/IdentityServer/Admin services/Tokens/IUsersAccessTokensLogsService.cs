...
namespace FoundersPC.Web.Application.Interfaces.Services.IdentityServer.Admin_services.Tokens
{
    public interface IUsersAccessTokensLogsService
    {
        ...
        Task<IEnumerable<AccessTokenLogReadDto>> GetPaginateableAccessTokensLogsAsync(
            int pageNumber,
            int pageSize,
            string adminToken);
        ...
        Task<IEnumerable<AccessTokenLogReadDto>> GetAllUserAccessTokensLogsByUserEmail(
            string userEmail,
            string adminToken);
    }
}
...
namespace FoundersPC.Infrastructure.API.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable("ProcessorCores",
                                         table => new
                                                  {
            ...
            migrationBuilder.CreateTable("Producers",
                                         table => new
                                                  {
                                                      Id = table.Column<int>("int", nullable : false)
                                                                .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable("VideoCardCores",
                                         table => new
                                                  {
                                                      Id = table.Column<int>("int", nullable : false)
                                                                .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable("Cases",
                                         table => new
                                                  {
                                                      Id = table.Column<int>("int", nullable : false)
                                                                .Annotation("SqlServer:Identity", "1, 1"),
                                         ...
                                         constraints : table =>
                                                       {
                                                           ...
                                                           table.ForeignKey("FK_Cases_Producers_ProducerId",
                                                                            x => x.ProducerId,
                                                                            "Producers",
                                                                            "Id",
            ...
            migrationBuilder.CreateTable("HardDrives",
                                         table => new
                                                  {
                                                      Id = table.Column<int>("int", nullable : false)
                                                                .Annotation("SqlServer:Identity", "1, 1"),
                                         ...
                                         constraints : table =>
                                                       {
                                                           ...
                                                           table.ForeignKey("FK_HardDrives_Producers_ProducerId",
                                                                            x => x.ProducerId,
                                                                            "Producers",
                                                                            "Id",
                                                                            onDelete : ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable("Motherboards",
                                         table => new
                                                  {
                                                      Id = table.Column<int>("int", nullable : false)
                                                                .Annotation("SqlServer:Identity", "1, 1"),
                                                      ...
                                                      PCIExpressVersion =
                                                          table.Column<string>("nvarchar(12)",
                                                                               maxLength : 12,
                                                                               nullable : false),
                                                      ProducerId = table.Column<int>("int", nullable : false),
                                                      MarketLaunch = table.Column<DateTime>("datetime2", nullable : true)
                                         ...
                                         constraints : table =>
                                                       {
                                                           ...
                                                           table.ForeignKey("FK_Motherboards_Producers_ProducerId",
                                                                            x => x.ProducerId,
                                                                            "Producers",
                                                                            "Id",
                                                                            onDelete : ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable("PowerSupplies",
                                         table => new
                                                  {
                                                      Id = table.Column<int>("int", nullable : false)
                                                                .Annotation("SqlServer:Identity", "1, 1"),
                                                      ...
                                                      MotherboardPowering =
                                                          table.Column<string>("nvarchar(10)",
                                                                               maxLength : 10,
                                                                               nullable : false),
                                         ...
                                         constraints : table =>
                                                       {
                                                           ...
                                                           table.ForeignKey("FK_PowerSupplies_Producers_ProducerId",
                                                                            x => x.ProducerId,
                                                                            "Producers",
                                                                            "Id",
                                                                            onDelete : ReferentialAction.Cascade);
                                         ...
                                         table => new
                                                  {
                                                      Id = table.Column<int>("int", nullable : false)
                                                                .Annotation("SqlServer:Identity", "1, 1"),
                                                      MemoryType =
                                                          table.Column<string>("nvarchar(15)",
                                                                               maxLength : 15,
                                                                               nullable : false),
                                                      Frequency = table.Column<int>("int", nullable : false),
                                                      CASLatency =
                                                          table.Column<string>("nvarchar(5)",
                                                                               maxLength : 5,
                                                                               nullable : false),
                                         ...
                                         constraints : table =>
                                                       {
                                                           ...
                                                           table.ForeignKey("FK_SolidStateDrives_Producers_ProducerId",
                                                                            x => x.ProducerId,
                                                                            "Producers",
                                                                            "Id",
                                                                            onDelete : ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable("VideoCards",
                                         table => new
                                                  {
                                                      Id = table.Column<int>("int", nullable : false)
                                                                .Annotation("SqlServer:Identity", "1, 1"),
                                                      ...
                                                      VideoMemoryType =
                                                          table.Column<string>("nvarchar(7)",
                                                                               maxLength : 7,
                                                                               nullable : false),
                                         ...
                                         constraints : table =>
                                                       {
                                                           ...
                                                           table.ForeignKey("FK_VideoCards_Producers_ProducerId",
                                                                            x => x.ProducerId,
                                                                            "Producers",
                                                                            "Id",
                                                                            onDelete : ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex("IX_Cases_ProducerId",
                                         "Cases",
                                         "ProducerId");

            migrationBuilder.CreateIndex("IX_HardDrives_Id",
                                         "HardDrives",
                                         "Id");

            migrationBuilder.CreateIndex("IX_HardDrives_ProducerId",
                                         "HardDrives",
                                         "ProducerId");

            migrationBuilder.CreateIndex("IX_Motherboards_Id",
                                         "Motherboards",
                                         "Id");

            migrationBuilder.CreateIndex("IX_Motherboards_ProducerId",
                                         "Motherboards",
                                         "ProducerId");

            migrationBuilder.CreateIndex("IX_PowerSupplies_Id",
                                         "PowerSupplies",
                                         "Id");

            migrationBuilder.CreateIndex("IX_PowerSupplies_ProducerId",
                                         "PowerSupplies",
                                         "ProducerId");

            migrationBuilder.CreateIndex("IX_Processors_Id",
                                         "Processors",
                                         "Id");

            migrationBuilder.CreateIndex("IX_Processors_ProcessorCoreId",
                                         "Processors",
                                         "ProcessorCoreId");

            migrationBuilder.CreateIndex("IX_Processors_ProducerId",
                                         "Processors",
                                         "ProducerId");

            migrationBuilder.CreateIndex("IX_Producers_Id",
                                         "Producers",
                                         "Id");
            ...
            migrationBuilder.CreateIndex("IX_SolidStateDrives_ProducerId",
                                         "SolidStateDrives",
                                         "ProducerId");

            migrationBuilder.CreateIndex("IX_VideoCards_GraphicsProcessorId",
                                         "VideoCards",
                                         "GraphicsProcessorId");

            migrationBuilder.CreateIndex("IX_VideoCards_Id",
                                         "VideoCards",
                                         "Id");

            migrationBuilder.CreateIndex("IX_VideoCards_ProducerId",
                                         "VideoCards",
                                         "ProducerId");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable("HardDrives");

            migrationBuilder.DropTable("Motherboards");

            migrationBuilder.DropTable("PowerSupplies");
            ...
            migrationBuilder.DropTable("VideoCards");

            migrationBuilder.DropTable("ProcessorCores");

            migrationBuilder.DropTable("Producers");

            migrationBuilder.DropTable("VideoCardCores");
        }
    }
}
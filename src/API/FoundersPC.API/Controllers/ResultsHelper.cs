...
namespace FoundersPC.API.Controllers
{
	...
	{
		public static ActionResult NotFoundByIdResult(int id) => new ContentResult
																 {
																		 Content = $"Entity with id = {id} not found",
																		 StatusCode = (int)HttpStatusCode.NotFound
																 };

		public static ActionResult BadRequestWithIdResult(object obj = null) => new ContentResult
																				{

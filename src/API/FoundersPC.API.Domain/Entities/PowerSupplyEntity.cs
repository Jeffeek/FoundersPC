...
{
    [Index(nameof(Id))]
    public class PowerSupplyEntity : HardwareEntityBase, IEquatable<PowerSupplyEntity>
    {
        [Range(50, 10000)]
        [Column("Power")]
        ...
        /// <inheritdoc/>
        public bool Equals(PowerSupplyEntity other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((PowerSupplyEntity)obj);
        }

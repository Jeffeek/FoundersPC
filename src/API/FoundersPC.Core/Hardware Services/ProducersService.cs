...
namespace FoundersPC.Services.Hardware_Services
{
    public class ProducersService : IProducerService
    {
        ...
        {
            return _mapper.Map<IEnumerable<Producer>, IEnumerable<ProducerReadDto>>(await _unitOfWork.ProducersRepository
                                                                                                     .GetAllAsync());
        }
        ...
        {
            return _mapper.Map<Producer, ProducerReadDto>(await _unitOfWork.ProducersRepository.GetByIdAsync(producerId));
        }

...
namespace FoundersPC.Services.Hardware_Services.Hardware.Memory
{
    public class SSDService : ISSDService
    {
        ...
        {
            return _mapper.Map<IEnumerable<SSD>, IEnumerable<SSDReadDto>>(await _unitOfWork.SSDsRepository
                                                                                           .GetAllAsync());
        }
        ...
        {
            return _mapper.Map<SSD, SSDReadDto>(await _unitOfWork.SSDsRepository.GetByIdAsync(ssdId));
        }

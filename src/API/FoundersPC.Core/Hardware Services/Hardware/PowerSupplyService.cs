...
namespace FoundersPC.Services.Hardware_Services.Hardware
{
    public class PowerSupplyService : IPowerSupplyService
    {
        ...
        {
            return _mapper.Map<IEnumerable<PowerSupply>, IEnumerable<PowerSupplyReadDto>>(await _unitOfWork
        ...
        {
            return _mapper.Map<PowerSupply, PowerSupplyReadDto>(await _unitOfWork.PowerSuppliersRepository

...
namespace FoundersPC.Services.Hardware_Services.Hardware.GPU
{
    public class VideoCardCoreService : IVideoCardCoreService
    {
        ...
        {
            return _mapper.Map<IEnumerable<VideoCardCore>, IEnumerable<VideoCardCoreReadDto>>(await _unitOfWork
        ...
        {
            return _mapper.Map<VideoCardCore, VideoCardCoreReadDto>(await _unitOfWork.VideoCardCoresRepository

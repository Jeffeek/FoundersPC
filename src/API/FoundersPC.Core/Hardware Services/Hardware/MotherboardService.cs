...
namespace FoundersPC.Services.Hardware_Services.Hardware
{
    public class MotherboardService : IMotherboardService
    {
        ...
        {
            return _mapper.Map<IEnumerable<Motherboard>, IEnumerable<MotherboardReadDto>>(await _unitOfWork
        ...
        {
            return _mapper.Map<Motherboard, MotherboardReadDto>(await _unitOfWork.MotherboardsRepository

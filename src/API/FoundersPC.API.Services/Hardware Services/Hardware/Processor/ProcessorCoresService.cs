...
{
    public class ProcessorCoresService : IProcessorCoresService
    {
        private readonly IMapper _mapper;
        private readonly IUnitOfWorkHardwareAPI _unitOfWorkHardwareAPI;

        public ProcessorCoresService(IUnitOfWorkHardwareAPI unitOfWorkHardwareAPI, IMapper mapper)
        {
        ...
        #region Implementation of IProcessorCoresService

...
{
    public class VideoCardCoresService : IVideoCardCoresService
    {
        private readonly IMapper _mapper;
        private readonly IUnitOfWorkHardwareAPI _unitOfWorkHardwareAPI;

        public VideoCardCoresService(IUnitOfWorkHardwareAPI unitOfWorkHardwareAPI, IMapper mapper)
        {
        ...
        #region Implementation of IVideoCardCoresService

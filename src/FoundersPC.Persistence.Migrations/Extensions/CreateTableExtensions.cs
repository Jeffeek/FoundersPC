...
namespace FoundersPC.Persistence.Migrations.Extensions
{
    internal static class CreateTableExtensions
    {
        public static ICreateTableWithColumnSyntax AddAuditableColumns(this ICreateTableWithColumnSyntax builder) =>
            builder.WithColumn("Created").AsDateTime().WithDefault(SystemMethods.CurrentDateTime)
                   .WithColumn("CreatedById").AsInt32().ForeignKey("FK_Users_CreatedById", "Users", "Id")
                   .WithColumn("LastModified").AsDateTime().WithDefault(SystemMethods.CurrentDateTime)
                   .WithColumn("LastModifiedById").AsInt32().ForeignKey("FK_Users_LastModifiedById", "Users", "Id");
        ...
        public static ICreateTableWithColumnSyntax AddSoftDeleteColumns(this ICreateTableWithColumnSyntax builder) =>
            builder
                ...
                .WithColumn("DeletedById").AsInt32().ForeignKey("FK_Users_DeletedById", "Users", "Id").Nullable();

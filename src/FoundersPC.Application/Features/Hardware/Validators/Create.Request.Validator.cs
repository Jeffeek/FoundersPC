...
public class CreateBaseValidator<TRequest> : AbstractValidator<TRequest>
    where TRequest : HardwareInfo
{
    private readonly IDbContextFactory<ApplicationDbContext> _dbContextFactory;

    protected CreateBaseValidator(IDbContextFactory<ApplicationDbContext> dbContextFactory)
    {

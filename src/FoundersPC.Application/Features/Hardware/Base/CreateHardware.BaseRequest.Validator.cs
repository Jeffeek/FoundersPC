...
public abstract class CreateHardwareRequestValidator<TRequest> : AbstractValidator<TRequest>
    where TRequest : HardwareInfo
{
    private readonly IDbContextFactory<ApplicationDbContext> _dbContextFactory;

    protected CreateHardwareRequestValidator(IDbContextFactory<ApplicationDbContext> dbContextFactory)
    {
